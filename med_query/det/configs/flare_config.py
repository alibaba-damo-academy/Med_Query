...
class Configs(DefaultConfigs):
    def __init__(self):
        ...
        self.dataset.type = "FLAREDataset"
        ...
        self.dataset.normalization_params.min_value = -125
        self.dataset.normalization_params.max_value = 225
        ...
        self.dataset.aug_params.translation = [-40, 40]  # mm
        self.dataset.aug_params.scale = [0.9, 1.1]  # ratio
        # rotation axis defined in rai frame, set it to [0, 0, 0] for random axis
        self.dataset.aug_params.rotation_axis = [0, 0, 0]
        self.dataset.aug_params.rotation_angle = [-5, 5]  # degree

        #########################
        #     Architecture      #
        #########################
        self.num_classes = 9  # not including background
        self.backbone = dict(
            type="ResNet",
            depth=50,
            in_channels=1,
