...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = build_conv_layer(
            conv_cfg, inplanes, planes, kernel_size=1, stride=self.conv1_stride, bias=False
        )
        self.add_module(self.norm1_name, norm1)
...
class ResNet(nn.Module):
    ...
    Args:
        ...
        dim (int): 2D network or 3D network.
    ...
    def _make_stem_layer(self, in_channels, stem_channels):
        ...
        if self.dim == 2:
            ...
            raise ValueError(f"can not operate on such {self.dim}D network")
...
@BACKBONES.register_module()
class ResNet_NP(ResNet):
    """ResNet without pooling layer and stride=1 in conv1"""

    def __init__(self, **kwargs):
        super(ResNet_NP, self).__init__(**kwargs)
